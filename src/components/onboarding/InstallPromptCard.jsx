...
function InstructionModal({ open, onClose, isIOS, isAndroid, isSafari }) {
  if (!open) {
    return null
  }
  ...
  return (
    <>
      ...
      >
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          <button type="button" className={PRIMARY_BUTTON_CLASS} onClick={promptInstall}>
            {canPromptInstall ? 'Install VITA now' : 'Show install steps'}
          </button>
